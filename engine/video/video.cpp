...
namespace muyuy
{
    namespace video
    {
        ...
        void VideoEngine::createInstance()
        {
            ...
            appInfo.pApplicationName = "Muyui House";
        ...
        void VideoEngine::setupDebugMessenger()
        {
            if (!enableValidationLayers)
                return;
        ...
        void VideoEngine::populateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT &createInfo)
        {
            createInfo = {};
        ...
        VkResult VideoEngine::CreateDebugUtilsMessengerEXT(VkInstance instance, const VkDebugUtilsMessengerCreateInfoEXT *pCreateInfo, const VkAllocationCallbacks *pAllocator, VkDebugUtilsMessengerEXT *pDebugMessenger)
        {
        ...
        void VideoEngine::DestroyDebugUtilsMessengerEXT(VkInstance instance, VkDebugUtilsMessengerEXT debugMessenger, const VkAllocationCallbacks *pAllocator)
        {
        ...
        bool VideoEngine::isDeviceSuitable(VkPhysicalDevice device)
        {
        ...
        QueueFamilyIndices VideoEngine::findQueueFamilies(VkPhysicalDevice device)
        {
        ...
        bool VideoEngine::checkDeviceExtensionSupport(VkPhysicalDevice device)
        {
        ...
        SwapChainSupportDetails VideoEngine::querySwapChainSupport(VkPhysicalDevice device)
        {
        ...
        VkSurfaceFormatKHR VideoEngine::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR> &availableFormats)
        {
        ...
        VkPresentModeKHR VideoEngine::chooseSwapPresentMode(const std::vector<VkPresentModeKHR> &availablePresentModes)
        {
        ...
        VkExtent2D VideoEngine::chooseSwapExtent(const VkSurfaceCapabilitiesKHR &capabilities)
        {
        ...
        VkShaderModule VideoEngine::createShaderModule(const std::vector<char> &code)
        {
        ...
        VkImageView VideoEngine::createImageView(VkImage image, VkFormat format)
        {
